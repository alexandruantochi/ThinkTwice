    ...
    public function run()
    {
        ...
        $campaigns = array(
            ...
            array(
                ...
                'category' => 'animals',
                'organizer_id' => 1,
                'created_at' => date('Y-m-d H:i:s', CampaignConfigurations::generate_random_timestamp()),
                'updated_at' => date('Y-m-d H:i:s', CampaignConfigurations::generate_random_timestamp())
            ),
            array(
